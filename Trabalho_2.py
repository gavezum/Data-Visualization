...
path = 'C:/Users/55199/Desktop/2 semester/Data visualization/New folder/Codigo Dash vindo do Joao/Codigo Dash vindo do Joao/'
...
app.layout = html.Div([
    ...
    html.Div([
        ...
        ], className='box', style={'width': '35%', 'display': 'inline-block', 'float': 'left'}
        ),
